...
export default function TimeBackAudit() {
  return (
    <main className="bg-white dark:bg-neutral-950">
      <ViewContentTracker
        contentId="time-back"
        contentName="AI Time Back & Freedom Audit"
        contentType="audit"
      />
      ...
      >
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-800 dark:border-blue-500/40 dark:bg-blue-500/10 dark:text-blue-300">
            ...
            Automate what drains you • Evenings &amp; weekends back • Scale without hiring
          </div>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-3xl px-6 pt-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-3 text-sm text-neutral-600 dark:text-neutral-300">
              Automation that handles sales, recovery and support 24/7
            </p>
          </a>
        </div>
      </div>

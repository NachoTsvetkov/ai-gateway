import { VoiceShoppingChat } from "components/ai/voice-shopping-chat";
...
export const metadata = {
  ...
  description:
    "Shop with your voice — hands-free AI experience. Speech-to-text + text-to-speech powered by Web Speech API.",
};

export default function VoiceEnabledShoppingAssistantPage() {
  return (
    <>
      <div className="border-b border-neutral-200 bg-neutral-100 px-6 py-2.5 dark:border-neutral-800 dark:bg-neutral-800/50">
        <div className="mx-auto flex max-w-7xl items-center gap-3">
          <Link
            href="/projects"
            className="inline-flex items-center gap-1 text-xs font-medium text-neutral-500 transition-colors hover:text-sky-600 dark:text-neutral-400 dark:hover:text-sky-400"
          >
            <svg
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-sky-950 via-blue-900 to-neutral-900">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-sky-500/25 via-transparent to-transparent" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 sm:py-20 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-sky-500/30 bg-sky-500/10 px-4 py-1.5 text-sm text-sky-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <p className="mt-4 text-lg font-medium text-neutral-200 sm:text-xl">
              Shop with your voice — hands-free AI experience
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 text-2xl font-bold tracking-tight text-neutral-900 sm:text-3xl dark:text-white">
              Hands-free commerce, fully integrated
            </h2>
          </div>
            ...
            {[
              {
                ...
                body: "Tap the mic button to speak your query. Web Speech API transcribes in real time with interim results shown live.",
              },
              {
                title: "Text-to-speech output",
                body: "The AI reads every response aloud using browser SpeechSynthesis. Toggle the speaker icon to mute/unmute.",
              },
              {
                title: "Voice + text mode toggle",
                body: "Switch between voice and text mode anytime. The text input always works — voice is an enhancement, not a requirement.",
              },
              {
                title: "Full shopping experience",
                body: "Product cards, add to cart, and catalog RAG work identically to the text-only chatbots. Perfect for accessibility and mobile shopping.",
              },
            ].map((item) => (
              <div
                key={item.title}

...
export default function AIShopifyStorePage() {
  // Layout order is intentional: this page is framed as a standalone
  // shop on a "subdomain", so the visitor lands on PRODUCTS first
  // (ThreeItemGrid + Carousel), exactly like a real storefront.
  // The Hero — which carries the "Demo for Fiverr" framing, the
  // brand statement, and the product/AI CTAs — sits BELOW the shop
  // so it reads as the "about this build" footer-ish moment, not as
  // the page's headline. The breadcrumb back to /projects is gone for
  // the same reason: subdomains don't show their parent site's nav.
  return (
    <>
      <ThreeItemGrid />
      <Carousel />

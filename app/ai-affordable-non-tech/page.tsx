...
export const metadata = {
  title: 'Free Personalized AI Opportunity Report | Simple AI for Non-Tech Small Business Owners',
  description: 'Get a free personalized AI Opportunity Report with affordable, easy-to-understand AI ideas designed for non-technical owners. Personally reviewed and sent in 48 hours.',
};
      ...
      <div className="mx-auto max-w-3xl px-6 py-12 lg:py-16">
        <div className="text-center mb-6">
          ...
          <p className="mt-2 text-neutral-600 dark:text-neutral-400">
            Answer a few short questions and I'll personally review them and send you a tailored AI Opportunity Report with simple, affordable ideas that make sense for non-technical owners — within 48 hours. 100% free, no obligation.
          </p>
        </div>

        <ReportRequestForm
          source="affordable-non-tech"
          title="Affordable AI for Non-Tech Report"
